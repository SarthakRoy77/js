...
- This program has used OOP [Object-Oriented - Programming] to make 
two classes that has many methods and properties that can be used to manage 
a Zoo.
- There are features such as Budget system while paying the staff according to 
its salary.
- The process of making new objects / recording animals/ hiring new staff. You can also 
assign budget using the pre-built-function
- To celebrate the birthday of our beloved staff and animals, we also have 
a celebrateBirthday function and with an age system to update the age.
